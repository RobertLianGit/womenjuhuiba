...
export async function POST(request: NextRequest) {
  ...
  const { activity_id, user_id, user_name, location, activity_type, proposed_time, category } = body;
  ...
  const finalCategory = category || (proposed_time && !location ? 'time' : 'location');
